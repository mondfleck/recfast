!Compile with gfortran "-ffree-form -o recfast_tm recfast_tm.f"
!but stops writing at z=610 (although print works OK)
...
!
! Copyright 1999-2008 by University of British Columbia.  All rights reserved.
!
...
!D	The matter temperature is also followed.
...
!A	Omega! is the Omega_0 in (cold) dark matter: OmegaT=OmegaC+OmegaB
...
!A	fu= "fudge factor" for H, to approximate low z behaviour
!A	b_He= "fudge factor" for HeI, to approximate higher z behaviour
!A	Heswitch=integer for modifying HeI recombination
...
!H			Jan 2022 (edited fortran dialect to compile!)
!H			
!-
!	===============================================================
...
!	dimensions for integrator
	...
	write(*,*)'recfast version 1.4'
	write(*,*)'Using Hummer''s case B recombination rates for H'
	write(*,*)' with H fudge factor = 1.14,'
...
! He is 99% singly ionized, and *then* switch to joint H/He recombination.
	  ...
	  write(7,'(1x,f8.2,2x,g15.8,2x,g15.8)')&
		zend,x,Tmat
	print*,zend,Tmat
